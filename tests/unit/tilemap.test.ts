...
describe('Tilemap Implementation (Task 3.3.2)', () => {
  ...
  it('should create a tilemap with at least 100x100 tiles', () => {
  ...
  it('should use Phaser.Tilemaps API', () => {
    return new Promise<void>((resolve, reject) => {
      scene.events.once('create', () => {
        try {
  ...
  it('should have tiles properly placed in the tilemap', () => {
    return new Promise<void>((resolve, reject) => {
      scene.events.once('create', () => {
        try {
          const tilemapLayers = scene.children.list.filter(
  ...
  it('should set appropriate tile size (50x50 pixels)', () => {
    return new Promise<void>((resolve, reject) => {
      scene.events.once('create', () => {
        try {
          const tilemapLayers = scene.children.list.filter(
